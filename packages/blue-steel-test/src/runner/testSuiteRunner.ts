import { BlueSteelConfig, RegisteredTest, TestOptions } from '@/discovery/types';
...
export class TestSuiteRunner {
    ...
    private config: BlueSteelConfig;
    ...
    private getActiveOptions(): TestOptions {
        const envOptions = process.env.BLUE_STEEL_TEST_URL ? {
            url: process.env.BLUE_STEEL_TEST_URL
        } : {};
    ...
    new Promise((resolve, reject) => {
        ...
        const proc = Bun.spawn({
            ...
            env: {
                NODE_ENV: 'test',
                ...process.env,
                BLUE_STEEL_WORKER_DATA: JSON.stringify(workerData)
            },
            cwd: process.cwd(),
            stdin: "inherit",
            stdout: "inherit",
